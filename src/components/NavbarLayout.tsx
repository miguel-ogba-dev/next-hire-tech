...
export default function NavbarLayout({
          ...
          <div className="flex items-center space-x-10">
            <Link href="/" className="flex items-center">
              <motion.div whileHover={{ scale: 1.2 }}>
                <Image
                  src="/NextHireTech.png"
                  alt="NextHireTech Logo"
                  width={140}
                  height={50}
  ...
  >
    <a
      ...
      className="px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-full hover:from-blue-700 hover:to-indigo-700 font-semibold transition-all shadow-lg flex items-center gap-2"
    >
      Agendar una demo
      <svg

    ...
    <div className="flex flex-col lg:flex-row gap-12 items-center">
      ...
      >
        ...
        <div className="mb-8 p-6 bg-blue-50 rounded-lg border-l-4 border-blue-500">
          <h3 className="text-xl font-semibold text-blue-800 mb-2">Misión</h3>
          <p className="text-gray-700">
            Conectar talento tecnológico y empresas con IA y datos, reduciendo tiempos y elevando la calidad del reclutamiento.
          </p>
        </div>

        <div className="p-6 bg-indigo-50 rounded-lg border-l-4 border-indigo-500">
          <h3 className="text-xl font-semibold text-indigo-800 mb-2">Visión</h3>
          <p className="text-gray-700">
            Ser la plataforma líder en Latinoamérica en reclutamiento inteligente, creando oportunidades inclusivas y competitivas.
          </p>
        </div>
      </motion.div>
    </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0 text-sm">
              ©️ {new Date().getFullYear()} Next Hire Tech. Todos los derechos
              reservados.
            </div>

...
export default function Home() {
  ...
  const testimonials = [
    {
      ...
      name: "Ana Martínez",
      role: "Diseñadora UX",
      content: "Gracias a Next Hire Tech encontré mi trabajo ideal en solo 2 semanas. Su sistema de matching es increíblemente preciso.",
      avatar: "/avatar1.png",
      company: "Google"
    },
    {
    ...
    },
    {
      ...
      content: "Contratamos a 3 excelentes profesionales a través de Next Hire Tech. La calidad de los candidatos es excepcional.",
      avatar: "/avatar3.png",
      company: "Meta"
    },
  ];
  ...
  >
    Next Hire Tech es una{" "}
    <span className="font-bold text-gray-900">
      plataforma de reclutamiento potenciada por inteligencia artificial
    </span>{" "}
    que conecta a empresas con talento tecnológico recién egresado, preseleccionado y listo para generar impacto desde el primer día.
  </motion.p>
  ...
  >
    Nuestra tecnología analiza automáticamente el perfil de cada candidato, genera evaluaciones técnicas adaptativas, y cruza estos datos con información del mercado laboral en tiempo real para ofrecer coincidencias basadas en evidencia. 
  </motion.p>

  <motion.p 
    variants={itemVariants}
    className="text-base text-gray-500 leading-relaxed mt-4"
  >
  </motion.p>
</div>
            ...
            >
              ...
              >
                ...
                <div className="relative z-10 text-center">
                  ...
                  >
                    Con inteligencia artificial, conectamos a cada persona con la oportunidad donde puede generar más valor desde el primer día.
                  </motion.p>
...
>
  <source src="/nexthiretech.mp4" type="video/mp4" />
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <motion.p 
              ...
              className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto"
            >
              Personas reales que transformaron sus carreras con Next Hire Tech
            </motion.p>
          </motion.div>
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-6 mb-12">
             <motion.a
  href="https://forms.office.com/Pages/ResponsePage.aspx?id=pj5axnwPC0CJNFptwXBWRUcmPYx4q-1LvAcWuY2vfjZUQjU2RUcxVkZEWkYxQjVRQlpWVThVQVMzTy4u"
  target="_blank"
  rel="noopener noreferrer"
  whileHover={{ scale: 1.05 }}
  whileTap={{ scale: 0.95 }}
  className="group relative px-12 py-6 bg-white text-gray-900 rounded-2xl font-bold text-lg shadow-md overflow-hidden inline-block text-center"
>
  Agendar una demo
</motion.a>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
            ...
            <div className="lg:col-span-2">
              <div className="mb-8">
                <img
                  src="/Next Hire Tech1.png"
                  alt="Next Hire Tech Logo"
          ...
          <div className="pt-8 border-t border-gray-800 flex flex-col lg:flex-row justify-between items-center gap-6">
            <div className="text-base text-gray-400 text-center lg:text-left">
              © {new Date().getFullYear()} Next Hire Tech. Todos los derechos reservados.
